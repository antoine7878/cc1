...
exits!(ignore "logical operators", logical_not, "int main(void) { return !0 + !5 + 41; }", 42);
exits!(comparisons, "int main(void) { return (1 < 2) + (2 <= 2) + (3 > 2) + (3 >= 3) + (4 == 4) + (4 != 5) + 36; }", 42);
exits!(ignore "logical operators", logical_and_or, "int main(void) { return (1 && 2) + (0 || 3) + 40; }", 42);
...
exits!(ignore "logical operators", short_circuit_and, "int f(void) { return 0; } int main(void) { int x; x = 42; (0 && (x = 1)); return x; }", 42);
exits!(ignore "logical operators", short_circuit_or, "int main(void) { int x; x = 42; (1 || (x = 1)); return x; }", 42);
...
exits!(ignore "usual arithmetic conversions: icmp slt on unsigned operands", mixed_signedness, "int main(void) { unsigned u; int i; u = 1; i = -1; return (i < u) ? 42 : 7; }", 7);
...
exits!(ignore "sizeof", sizeof_int, "int main(void) { return sizeof(int) * 10 + 2; }", 42);
exits!(ignore "sizeof", sizeof_expr, "int main(void) { long l; return sizeof l * 10 + 2; }", 42);
exits!(ignore "cast", cast, "int main(void) { return (int) 42.9; }", 42);
...
exits!(ignore "enum", enum_constant, "enum e { A = 40, B }; int main(void) { return B + 1; }", 42);
