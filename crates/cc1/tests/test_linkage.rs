...
placements!(placement_tentative_external, "int x;", &[("x", "external", "static", "definition")]);

placements!(placement_tentative_internal, "static int x;", &[("x", "internal", "static", "definition")]);

placements!(placement_declaration_external, "extern int x;", &[("x", "external", "static", "declaration")]);

placements!(placement_definition_external, "int x = 1;", &[("x", "external", "static", "definition")]);
...
placements!(placement_function_declaration_no_duration, "int fn(void);", &[("fn", "external", "none", "declaration")]);
...
reject!(linkage_reject_block_extern_then_file_static, "void f(void) { extern int x; } static int x;");
reject!(linkage_reject_function_then_static_definition, "int g(void); static int g(void) { return 0; }");

accept!(linkage_accept_static_then_extern_inherits, "static int b; extern int b;");
accept!(linkage_accept_implicit_extern_function_inherits, "static int sf(void); int sf(void) { return 0; }");
accept!(linkage_accept_repeated_block_extern, "void f(void) { extern int x; extern int x; } int x;");
accept!(linkage_accept_no_linkage_local_never_meets_external, "void f(void) { int y; { extern double y; } }");
...
accept!(linkage_accept_internal_tentative_then_definition, "static int j; static int j = 1;");
...
reject!(tentative_never_completed_used, "struct S; static struct S x; struct S *p(void) { return &x; }");

accept!(tentative_completed_later, "struct S; static struct S x; struct S { int i; };");
accept!(tentative_array_completed, "static int a[]; int f(void) { return a[0]; }");
accept!(tentative_object_used, "static int sv; int f(void) { return sv; }");
accept!(internal_function_defined_then_used, "static int sf(void) { return 1; } int use(void) { return sf(); }");
accept!(internal_function_never_used, "static int sf(void); int use(void) { return 0; }");
accept!(internal_function_used_under_sizeof, "static int sf(void); int use(void) { return sizeof(&sf); }");
...
reject!(tentative_array_sizeof_before_completion, "int a[]; enum e { P = sizeof(a) };");
