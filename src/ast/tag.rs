...
define_arena!(Struct, StructArena, StructId, crate::parser::AstArenas, structs);
define_arena!(Union, UnionArena, UnionId, crate::parser::AstArenas, unions);
define_arena!(Enum, EnumArena, EnumId, crate::parser::AstArenas, enums);
define_arena!(Variant, VariantArena, VariantId, crate::parser::AstArenas, variants);
